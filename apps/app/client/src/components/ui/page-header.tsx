  ...
  return (
    ...
    >
      <div className="min-w-0 flex-1">
        ...
        <h1 className="text-h1 text-foreground" data-testid="text-page-title">{title}</h1>
        {description && (
          <p className="mt-2 text-muted-foreground max-w-2xl" data-testid="text-page-description">{description}</p>
        )}
        {children}
      </div>
