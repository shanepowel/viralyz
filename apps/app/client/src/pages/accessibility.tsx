    ...
    <div className="min-h-screen bg-card text-foreground">
      ...
      >
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-6 text-muted-foreground">
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Our Commitment</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Conformance Status</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Accessibility Features</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Known Limitations</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Feedback</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Enforcement Procedure</h2>
