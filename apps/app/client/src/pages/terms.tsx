    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      >
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-6 text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-white mt-8">5. Subscription and Payments</h2>
          ...
          <h2 className="text-2xl font-semibold text-white mt-8">6. Intellectual Property</h2>
          ...
          <h2 className="text-2xl font-semibold text-white mt-8">7. Disclaimer</h2>
          ...
          <h2 className="text-2xl font-semibold text-white mt-8">8. Limitation of Liability</h2>
          ...
          <h2 className="text-2xl font-semibold text-white mt-8">10. Contact</h2>
