    ...
    <div className="min-h-screen bg-card text-foreground">
      ...
      >
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-6 text-muted-foreground">
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Our Business</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Our Supply Chain</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Due Diligence</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8">Reporting Concerns</h2>
