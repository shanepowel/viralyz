      ...
      <div className="wrap">
        <section className="hero">
          <div>
            ...
            <div className="row">
              ...
              <Link href="/kit/maya" className="btn btn-ghost">See a sample media kit</Link>
            </div>
        ...
        <section className="band">
          ...
          <div className="band-grid">
            <div className="band-card"><div className="ico2">Hk</div><h4>Hook tester</h4><p>Ten opening lines for your idea, ranked by predicted score.</p></div>
            <div className="band-card"><div className="ico2">Tp</div><h4>Teleprompter</h4><p>Script feedback line by line while you record.</p></div>
            <div className="band-card"><div className="ico2">Th</div><h4>Thumbnail tests</h4><p>See your thumbnail next to competitors at real feed size.</p></div>
            <div className="band-card"><div className="ico2">Mk</div><h4>Media kit builder</h4><p>A verified one-link profile brands can check in seconds.</p></div>
            <div className="band-card"><div className="ico2">Rt</div><h4>Rate calculator</h4><p>Suggested rates based on creators like you in your niche.</p></div>
            <div className="band-card"><div className="ico2">Ac</div><h4>Creator academy</h4><p>Short courses on what actually moves your score.</p></div>
          </div>
        </section>
