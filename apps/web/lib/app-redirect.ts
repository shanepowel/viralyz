...
export const hookLabRedirect = createAppRedirect("/hook-lab");
export const captionStudioRedirect = createAppRedirect("/caption-studio");
export const ideasRedirect = createAppRedirect("/ideas");
export const trendsRedirect = createAppRedirect("/trends");
export const intelligenceRedirect = createAppRedirect("/intelligence");
